...
define("Const_SelfName", "AdmissionsApplication.php");
define("Const_AdmissionsAppEditLink", "https://www.nmu.edu/admissions/apply/application.shtml");
...
function Display_ApplicationPage10()
{
	try
	{
		...
		/* else
		{
			...
			$strThankYouError = '<strong>An e-mail confirmation for the admissions application was trying to send without a contact e-mail being provided</strong><br /><br />';
...
function SaveFormToDB_Page9()
{
	...
	if($_SESSION['us_citizen']=='No' &&  $_SESSION['us_resident']=='No')
	{
		$strQuery = "INSERT INTO admissions_applications_international SET 
	...
	{
		$strQuery = "INSERT INTO admissions_applications_domestic SET 
						php_timestamp='".$phpSubmitTime."',
						submitter_ip='".$ip."',
						first_name='".addslashes($_SESSION['first_name'])."',
						last_name='".addslashes($_SESSION['last_name'])."',
	...
	{
		CORE_SendMailMsg($strSubject, $strMsg, $aRecipients, $aCCs, $strSender, $strReplyTo);
	}
}
